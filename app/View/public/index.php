        ...
        <div class="hero-widget-wrapper">
            <div class="booking-widget">
                ...
                <div class="widget-footer">
                    ...
                    <a href="<?= BASEURL; ?>/home/lapangan" class="btn-widget">KONFIRMASI</a>
                </div>
            </div>
            ...
            <?php if (!empty($data['rekomen'])): ?>
                <?php foreach ($data['rekomen'] as $lap): ?>
                    <div class="card">
                        ...
                        <img src="<?= strpos($lap['foto_utama'], 'http') === 0 ? htmlspecialchars($lap['foto_utama']) : BASEURL . '/assets/uploads/lapangan/' . htmlspecialchars($lap['foto_utama']) ?>" 
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-info">
                                <div><i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($lap['lokasi'] ?? 'Bandar Lampung'); ?></div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= BASEURL; ?>/lapangan/<?= $lap['id']; ?>" class="btn-secondary compact-button">Detail</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
